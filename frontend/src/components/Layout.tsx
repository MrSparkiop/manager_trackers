...
import {
  ...
  Timer, Calendar, LogOut, User, Sun, Moon, Settings, Menu, X, Tag, Users, Shield, BarChart2
} from 'lucide-react'
      ...
      <nav style={{ flex: 1, padding: '12px 10px', display: 'flex', flexDirection: 'column', gap: '2px' }}>
        ...
        {(user as any)?.role === 'ADMIN' && (
          <NavLink to="/admin" style={({ isActive }) => ({
            ...
            padding: '9px 10px', borderRadius: '9px',
            fontSize: '13.5px', fontWeight: '500',
            textDecoration: 'none', transition: 'all 0.15s', marginTop: '4px',
            backgroundColor: isActive ? 'rgba(239,68,68,0.15)' : 'rgba(239,68,68,0.05)',
            color: '#f87171',
            border: isActive ? '1px solid rgba(239,68,68,0.3)' : '1px solid rgba(239,68,68,0.1)',
          })}>
            <Shield size={16} />
            Admin Panel
          </NavLink>
