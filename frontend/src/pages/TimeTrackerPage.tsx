...
export default function TimeTrackerPage() {
  ...
  const [manual, setManual] = useState({ description: '', taskId: '', date: new Date().toISOString().split('T')[0], startTime: '', endTime: '' })
  ...
  return (
    <div style={{ padding: '32px', fontFamily: 'Inter, sans-serif', minHeight: '100vh' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '28px' }}>
        <div>
          <h1 style={{ fontSize: '24px', fontWeight: '700', color: '#ffffff', margin: 0 }}>Time Tracker</h1>
          <p style={{ color: '#64748b', marginTop: '4px', fontSize: '14px' }}>Track time spent on your tasks</p>
        </div>
      ...
      {/* Timer */}
      <div style={{
        backgroundColor: '#0f172a', border: running ? '1px solid rgba(99,102,241,0.4)' : '1px solid #1e293b',
        borderRadius: '20px', padding: '32px', marginBottom: '28px',
        background: running ? 'linear-gradient(135deg, #0f172a 0%, #1a1040 100%)' : '#0f172a'
      }}>
        {/* Timer display */}
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          <div style={{
            fontSize: '64px', fontWeight: '700', color: running ? '#818cf8' : '#1e293b',
        ...
        {!running ? (
          ...
          <div style={{ display: 'flex', gap: '12px', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ flex: 1, backgroundColor: '#1e293b', borderRadius: '10px', padding: '14px 16px' }}>
      ...
      <div>
        ...
        {Object.keys(grouped).length === 0 ? (
          <div style={{ textAlign: 'center', padding: '48px 0' }}>
            <Clock size={40} color="#1e293b" style={{ margin: '0 auto 12px' }} />
            <p style={{ color: '#64748b', fontSize: '15px' }}>No time entries yet</p>
            <p style={{ color: '#475569', fontSize: '13px', marginTop: '4px' }}>Start the timer to track your time</p>
          </div>
        ) : (
              ...
              return (
                <div key={date}>
                  ...
                  <div style={{
                    ...
                    <span style={{ fontSize: '13px', fontWeight: '600', color: '#94a3b8' }}>{date}</span>
                    <span style={{ fontSize: '13px', color: '#64748b' }}>{formatDurationShort(totalSecs)}</span>
                  </div>
                    ...
                    {dateEntries.map(entry => (
                      <div key={entry.id} style={{
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <p style={{ fontSize: '14px', fontWeight: '500', color: '#f1f5f9', margin: 0 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
              ...
              <button onClick={() => setShowManual(false)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#64748b' }}>
                <X size={20} />
              </button>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div>
                <label style={{ display: 'block', fontSize: '13px', color: '#94a3b8', marginBottom: '6px' }}>Task (optional)</label>
                <select
                  value={manual.taskId}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                <div>
                  <label style={{ display: 'block', fontSize: '13px', color: '#94a3b8', marginBottom: '6px' }}>Start Time</label>
                  <input
                    type="time" value={manual.startTime}
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '13px', color: '#94a3b8', marginBottom: '6px' }}>End Time</label>
                  <input
                    type="time" value={manual.endTime}
              ...
              <div style={{ display: 'flex', gap: '10px', marginTop: '8px' }}>
                ...
                <button
                  ...
                  disabled={!manual.startTime || !manual.endTime}
                  style={{
                    flex: 1, padding: '11px', borderRadius: '10px',
